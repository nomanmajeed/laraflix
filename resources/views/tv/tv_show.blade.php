...
@section('content')
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-6 flex flex-col md:flex-row">
            <img src="{{ 'https://image.tmdb.org/t/p/w500' . $tvshow['poster_path'] }}" alt="" class="w-64 md:w-96">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold">{{ $tvshow['name'] }}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm mt-1">
                    <svg class="fill-current w-4 text-orange-500 mr-1" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="mt-6">
                    <div class="flex mt-4">
                        <div>
                            <div> Description</div>
                            <p class="text-gray-600">{{ $tvshow['overview'] }} </p>
                        </div>
                    </div>
                </div>
                ...
                @if ($tvshow['created_by'])
                    <div class="mt-12">
                        <h4 class="text-white font-semibold">TV Show Creator</h4>
                        <div class="flex mt-4">
    ...
    <div class="movie-images border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($tvshow['images']['backdrops'] as $screenshot)
                    @if ($loop->index < 12)
                        <div class="mt-8">
                            <a href="#">
